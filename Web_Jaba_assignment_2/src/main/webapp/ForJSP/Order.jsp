        ...
        <form  method = "post" action = "<%=request.getContextPath()%>/OrderServlet">
            ...
            <div class="first">
                ...
                <div>
                    <p> What's your telephone number ?
                        <input type="text" name="Telephone" placeholder="+7**********">
                    </p>
                </div>
            ...
            <div class="first">
                ...
                <div>
                    <p>
                        Select your country:
                        <select name="OrderCountry" style="width: 200px; height:30px; border:1px solid black;border-radius: 5px;">
            ...
            <div class="second">
                ...
                <div>
                    <p>
                        ...
                        <input id="card" type="radio" name="OrderOption" value="card">kaspi.kz <br/>
                        <input id="cash" type="radio" name="Orderoption" value="cash">Cash
                    </p>
                </div>

                <div class="eff">
                    <input type = "submit" style=" cursor: pointer;width: 60px; height: 30px; border:1px solid black;border-radius: 5px;">
                </div>
